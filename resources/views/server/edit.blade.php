...
@section('serverFormContent')
    <div>
        ...
        <h1 class="text-2xl font-semibold text-center text-gray-500 mt-8 mb-6">Edit Server details</h1>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="name" name="hostname" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500" value="{{ $server->hostname }}" required>
        </div>
        <div class="mb-4">
            <label for="server_ip" class="block mb-2 text-sm text-gray-600">Server IP</label>
            <input type="text" id="server_ip" name="ip_address" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500" value="{{ $server->ip_address }}" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="number" id="serverMemory" name="server_memory" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500" min="0" value="{{ $server->server_memory }}" required>
        </div>

        <div class="mb-4">
            <label for="diskSpace" class="block mb-2 text-sm text-gray-600">Assign disk space</label>
            <input type="number" id="diskSpace" name="disk_space" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500" min="0" value="{{ $server->disk_space }}" required>
        </div>
